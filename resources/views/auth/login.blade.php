...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <!-- Kotak Hitam -->
    <div class="bg-black my-16 mx-6 rounded-2xl p-16 flex space-x-12 w-[1350px] h-[750px] max-w-full justify-center items-center">
    ...
    <!-- Bagian Logo -->
        ...
        <div class="bg-white rounded-lg p-10 shadow w-[400px] flex flex-col justify-center">
            ...
            <form action="{{ route('doLogin') }}" method="POST" class="space-y-5">
                @csrf
                <!-- Email -->
