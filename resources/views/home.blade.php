...
<body class="bg-gray-50 font-sans text-gray-800">
    ...
    <aside class="w-64 bg-black text-white flex flex-col justify-between fixed top-0 left-0 h-full border-r-4 border-blue-500 overflow-auto">
        <div>
    ...
    <main class="flex-1 p-8 ml-64">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="#" class="bg-black text-white px-4 py-2 rounded-md shadow hover:bg-gray-800 transition">+
                Report New Item</a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <article class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm flex flex-col">
                ...
                <p class="text-gray-600 mb-4 text-sm">
                    I lost my black leather wallet while jogging in Gotham Park. Inside there were some cash, a student
                    ID, and a few important cards.
                </p>
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M8 7V3M16 7V3M3 11h18M5 21h14a2 2 0 002-2v-7H3v7a2 2 0 002 2z"></path>
                        </svg>
            ...
            <article class="bg-white rounded-lg border border-gray-200 p-6 shadow-sm flex flex-col">
                ...
                <p class="text-gray-600 mb-4 text-sm">
                    I misplaced my water bottle in the school cafeteria after lunch. It's a blue reusable bottle with a
                    sticker on the side.
                </p>
