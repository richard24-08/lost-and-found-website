...
<<<<<<< HEAD
<!-- Tailwind CDN (quick preview tanpa Vite) -->
=======
>>>>>>> 4579bda (update baru)
...
<<<<<<< HEAD
    <!-- Layout: left (2/3) image + details, right (1/3) cards -->
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">

        <!-- LEFT: large image + item card (span 2) -->
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <!-- icons row: category / date / location / last seen -->
...
=======
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between">
            <div>
                <h2 class="text-2xl md:text-3xl font-extrabold tracking-tight">{{ $report->item_name }}</h2>
                <p class="text-sm text-gray-500 mt-2 max-w-2xl">
                {{ $report->description }}
                </p>
            </div>
...
=======
                <div class="text-sm">{{ $report->category }}</div>
>>>>>>> 4579bda (update baru)
                </div>
            </div>
...
=======
                <div class="text-sm">{{ $report->last_seen }}</div>
>>>>>>> 4579bda (update baru)
                </div>
            </div>
            </div>
...
=======
                <div class="mt-1">{{ $report->brand }}</div>
                </div>
                <div>
                <div class="text-xs text-gray-400">Size</div>
                <div class="mt-1">{{ $report->size }}</div>
                </div>
                <div>
                <div class="text-xs text-gray-400">Color</div>
                <div class="mt-1">{{ $report->color }}</div>
>>>>>>> 4579bda (update baru)
                </div>
            </div>
            </div>
...
<<<<<<< HEAD
    ...
    function actionClick(name){
      // simple feedback - ganti dengan modal/ajax sesuai kebutuhan
        alert(name + ' clicked');
    }
    </script>
=======
